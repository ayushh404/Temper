...
const SignIn = () => {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input mt-44">
      ...
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300 mt-4">
        Don't have an account? <Link href="/register" className="font-extrabold">Register here </Link>
      </p>
      ...
      <form action={doSocialLogin} className="flex flex-col space-y-4">
        ...
        <button
          className="relative group/btn flex space-x-2 items-center justify-start px-4 w-full text-black rounded-md h-10 font-medium shadow-input bg-gray-50 dark:bg-zinc-900 dark:shadow-[0px_0px_1px_1px_var(--neutral-800)]"
          type="submit" name="action" value="twitter"
        >
